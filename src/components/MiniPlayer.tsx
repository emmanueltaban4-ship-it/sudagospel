import {
  ...
  Repeat, Shuffle, Heart, ListMusic, Maximize2, Music
} from "lucide-react";
      ...
      <div className="relative">
        ...
        <div className="md:hidden">
          ...
          <div className="flex items-center gap-2 px-3 py-2">
            {/* Cover art */}
            <button onClick={() => navigate(`/song/${currentTrack.id}`)} className="flex-shrink-0">
            ...
            {/* Track info */}
            <button onClick={() => navigate(`/song/${currentTrack.id}`)} className="flex-1 min-w-0 text-left">
        ...
        <div className="hidden md:block">
          <div className="flex items-center gap-4 px-4 py-2.5 max-w-screen-2xl mx-auto h-[72px]">
            ...
            <div className="flex items-center gap-3 w-[280px] flex-shrink-0">
              <button onClick={() => navigate(`/song/${currentTrack.id}`)} className="flex-shrink-0 group">
