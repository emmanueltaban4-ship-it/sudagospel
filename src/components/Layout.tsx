          ...
          <div className="pb-[140px] md:pb-[80px]">
            ...
            <footer className="border-t border-border/30 py-5 px-4 mt-10">
              <div className="flex items-center justify-center gap-4 mb-3">
                <a href="https://facebook.com/ssdguna" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-primary transition-colors"><Facebook className="h-4 w-4" /></a>
                <a href="https://twitter.com/ssdguna" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-primary transition-colors"><Twitter className="h-4 w-4" /></a>
                <a href="https://instagram.com/ssdguna" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-primary transition-colors"><Instagram className="h-4 w-4" /></a>
                <a href="https://youtube.com/@ssdguna" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-primary transition-colors"><Youtube className="h-4 w-4" /></a>
              </div>
