            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <Input value={accountEmail} onChange={(e) => setAccountEmail(e.target.value)} className="pl-10" placeholder="artist@ssdguna.net" />
                </div>
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div className="rounded-lg bg-muted p-4 text-sm text-muted-foreground space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>Email format: <code>artist.name@ssdguna.net</code></li>
