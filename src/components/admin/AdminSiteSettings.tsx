...
const SECTIONS: Section[] = [
  {
    ...
    fields: [
      { key: "site_name", label: "Site name", type: "text", placeholder: "Suda Gospel", maxLength: 60 },
      ...
      { key: "footer_text", label: "Footer text", type: "text", placeholder: "© 2026 Suda Gospel" },
    ],
  },
  {
    id: "seo",
    ...
    fields: [
      ...
      { key: "canonical_url", label: "Canonical URL", type: "url", placeholder: "https://sudagospel.net" },
