        ...
        {data && !loading && (
          <div className="space-y-3">
            ...
            <div className="rounded-xl overflow-hidden border bg-card">
              {data.image ? (
                <img src={data.image} alt="OG" className="w-full aspect-[1.91/1] object-cover bg-muted" loading="lazy" decoding="async" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
              ) : (
