            ...
            {purchases.map((p: any) => (
              <Card key={p.id} className="p-3 flex items-center gap-3">
                <div className="h-12 w-12 rounded-lg bg-muted overflow-hidden flex-shrink-0">
                  {p.songs?.cover_url && <img src={p.songs.cover_url} alt="" className="h-full w-full object-cover" />}
                </div>
            ...
            {subs.map((s: any) => (
              <Card key={s.id} className="p-3 flex items-center gap-3">
                <div className="h-12 w-12 rounded-full bg-muted overflow-hidden flex-shrink-0">
                  {s.artists?.avatar_url && <img src={s.artists.avatar_url} alt="" className="h-full w-full object-cover" />}
                </div>
                <div className="flex-1 min-w-0">
