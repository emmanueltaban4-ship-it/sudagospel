  ...
  return (
    <div className="p-3 flex items-center gap-3">
      <div className="h-10 w-10 rounded-lg bg-muted overflow-hidden flex-shrink-0">
        {song.cover_url ? <img src={song.cover_url} alt="" className="h-full w-full object-cover" /> : <div className="h-full w-full bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center"><Music className="h-3.5 w-3.5 text-primary" /></div>}
      </div>
            ...
            {followers.map((f: any) => (
              <div key={f.user_id + f.created_at} className="p-3 flex items-center gap-3">
                <div className="h-9 w-9 rounded-full bg-muted overflow-hidden flex-shrink-0">
                  {f.profile?.avatar_url ? <img src={f.profile.avatar_url} alt="" className="h-full w-full object-cover" /> : <div className="h-full w-full bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center"><Users className="h-3.5 w-3.5 text-primary" /></div>}
                </div>
                <div className="flex-1 min-w-0">
