      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
        ...
        <section className="space-y-4 text-muted-foreground leading-relaxed">
          ...
          <div>
            ...
            <p>If you have any questions about these Terms, please contact us at <a href="mailto:support@ssdguna.net" className="text-primary hover:underline">support@ssdguna.net</a>.</p>
          </div>
        </section>
      </div>
    </Layout>
